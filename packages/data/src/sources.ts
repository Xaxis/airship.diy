...
export const SOURCES: readonly Source[] = [
  ...
  {
    id: 'nasa-solar-constant',
    title: 'Total Solar Irradiance Data, SORCE/TIM',
    author: 'NASA LASP',
    url: 'https://lasp.colorado.edu/lisird/',
    note: 'PRIMARY MEASUREMENT. 1361 W/m2 at 1 AU, replacing the older 1367 that most textbooks still carry.',
  },
  {
    id: 'meinel-applied-solar-energy',
    title: 'Applied Solar Energy: An Introduction',
    author: 'A. B. Meinel and M. P. Meinel',
    year: 1976,
    note: 'Source of the clear-sky air-mass attenuation law I = I0 * 0.7^(AM^0.678), which is the simplest form that gets clear-sky direct normal irradiance right to a few percent without a spectral model.',
  },
  {
    id: 'duffie-beckman',
    ...
    year: 2013,
    note: 'The standard reference for solar geometry, declination, air mass and ground reflectance.',
  },
  {
    id: 'payne-albedo-sea-surface',
    title: 'Albedo of the sea surface, Journal of the Atmospheric Sciences 29(5)',
    author: 'R. E. Payne',
    year: 1972,
    note: 'PRIMARY MEASUREMENT. Sea surface albedo against solar elevation. It matters here because this vehicle is over water most of the time, and water is much darker than land.',
  },
  {
    id: 'nrel-module-thermal',
    title: 'Photovoltaic Module Thermal/Wind Performance, NREL/CP-520-35645',
    author: 'D. L. King and others',
    year: 2004,
    note: 'Module absorptivity, emissivity and the operating-temperature model. Used here for the part of the hull the array covers, which is optically nothing like the cover around it.',
  },
  {
    id: 'kreider-airship-thermal',
    title: 'Mathematical modeling of high altitude balloon performance, AIAA 75-1385',
    author: 'J. F. Kreider',
    year: 1975,
    note: 'Internal and external convection coefficients for a large gas envelope, and the lumped formulation this module follows. Balloons rather than airships, which is the right literature: it is the same problem without the forward speed.',
  },
  {
    id: 'swinbank-longwave',
    title: 'Long-wave radiation from clear skies, Quarterly Journal of the Royal Meteorological Society 89',
    author: 'W. C. Swinbank',
    year: 1963,
  ...
  },
  {
    ...
    year: 1981,
    url: 'https://ntrs.nasa.gov/citations/19820008217',
    note: 'The only costed airship ground facility in the open literature. Table 7-8 gives a 425 by 150 by 128 ft hangar at $6.1M and a complete base at $8.053M, both quoted to NASA in 1981 by ASF Building Systems, who built the Goodyear hangar in Houston. Also carries the US Navy Airship Ground Handling Instructions wind limit table.',
  },
  {
    id: 'nasa-n76-15042',
    title: 'Mooring and Ground Handling Rigid Airships',
    author: 'Walker, in Proceedings of the Interagency Workshop on Lighter Than Air Vehicles',
    year: 1975,
    url: 'https://ntrs.nasa.gov/citations/19760007954',
    note: 'Ground crew sizes for real ships, from LZ-8 at 300 people to ZPG-3W at 18. Mast masses, riding-out circle radii, and the assumed crosswind docking side load on Akron. The primary source for what handling a rigid airship on the ground actually took.',
  },
  {
    id: 'bls-cpi-u',
    title: 'Consumer Price Index for All Urban Consumers, series CUUR0000SA0',
    author: 'US Bureau of Labor Statistics',
    url: 'https://www.bls.gov/cpi/',
    note: 'Used to bring the 1981 NASA facility costs forward. 1981 annual average 90.9 against July 2026 at 333.918, a factor of 3.6735. CPI-U understates construction cost inflation, so escalated facility figures here are a floor rather than a quote.',
  },
  {
    id: 'imarc-carbon-fibre-2025',
    title: 'Carbon Fibre Price Trend and Forecast',
    author: 'IMARC Group',
    year: 2025,
    url: 'https://www.imarcgroup.com/carbon-fiber-pricing-report',
    note: 'Commodity tow index, December 2025. The gap between this and retail fabric prices is the whole story of amateur composite cost: a factor of about seven, entirely in converting and distribution.',
  },
  {
    id: 'fibre-glast-catalogue',
    title: 'Fibre Glast Developments catalogue and vacuum bagging guide',
    url: 'https://www.fibreglast.com/',
    note: 'Retail prices and areal weights for the fabrics an individual can actually buy, quoted August 2026, and the fibre volume fractions achievable by hand layup with and without a bag.',
  },
  {
    id: 'dragonplate-pultruded',
    title: 'Pultruded carbon fibre tube, product listings',
    author: 'DragonPlate',
    url: 'https://dragonplate.com/pultruded-carbon-fiber-tube-2',
    note: 'Bought tube at $262/kg against retail fabric at $245/kg for a laminate you still have to make. The finding is that the tube is barely more expensive per kilogram and comes hot-cured, straight, and with no bagging consumables.',
  },
  {
    id: 'miasole-flex-03n',
    title: 'MiaSole FLEX SERIES FLEX-03N 2.6 METER datasheet, 302-191943-00_B',
    author: 'MiaSole',
    year: 2019,
    note: 'The lightest flexible photovoltaic module with a published areal mass: 1.9 kg/m2 bare and 2.6 kg/m2 with the adhesive that attaches it. Everything lighter in the literature is a laboratory cell rather than a module you can buy.',
  },
  {
    id: 'iea-electrolysers-2025',
    title: 'Electrolysers, Energy System Technology Report',
    author: 'International Energy Agency',
    year: 2025,
    url: 'https://www.iea.org/energy-system/low-emission-fuels/electrolysers',
    note: 'Installed system capex of USD 2,000 to 2,450 per kWe for alkaline and PEM. Utility-scale; a 40 kW unit carries a small-scale premium this model adds explicitly rather than hiding.',
  },
  {
    id: 'bnef-battery-survey-2025',
    title: 'Lithium-Ion Battery Price Survey',
    author: 'BloombergNEF',
    year: 2025,
    note: 'Global average pack price, published 9 December 2025. Quoted alongside the retail LFP price the project would actually pay, which is more than twice it.',
  },
  {
    id: 'doe-h2-delivery-record',
    title: 'Hydrogen Delivery and Dispensing Cost, Program Record 20007',
    author: 'US Department of Energy Hydrogen Program',
    year: 2020,
    url: 'https://www.hydrogen.energy.gov/library/program-records',
    note: 'Gaseous tube trailer delivery at a 450 kg/day station. The merchant price of hydrogen is about a dollar a kilogram and the delivered price is an order of magnitude more, which is the difference between the two figures this model reports.',
  },
  {
    id: 'usgs-helium',
    title: 'Mineral Commodity Summaries: Helium',
    ...
    note: 'Grade-A helium prices. Bulk quotes in 2025 run well above the USGS figure, which is why the helium first fill is given as a range rather than a number.',
  },
  {
    id: 'wikipedia-pathfinder-1',
    title: 'Pathfinder 1 (airship)',
    author: 'Wikipedia',
    url: 'https://en.wikipedia.org/wiki/Pathfinder_1',
    note: 'SECONDARY. LTA Research began work at Moffett Field in 2017 and first flew untethered on 24 October 2024. Seven years, in an existing hangar, funded by a Google founder, with a professional workforce. The most directly comparable modern programme and the honest calibration for any amateur schedule.',
  },
] as const
