...
export const BASELINE_ARRANGEMENT: Configuration = {
  ...
  compartments: [
    ...
    },
    {
      ...
      shell: false,
      enclosed: false,
      note: 'SIZED FOR A YEAR RATHER THAN BY EYE, and provisioned as a boat rather than as a spacecraft. Two people for a year is 1,530 kg of PACKAGED provisions at 2.1 kg each per day; the same nutrition as BULK DRY STAPLES is 584 kg, and the difference of 950 kg is more than the wings weigh. What it costs is galley time, 4.6 person-hours a day against 1.5, which on a two-person vehicle with a year to spend is the easiest trade in the whole design. This bay carries the staples plus engine consumables and the spares the maintenance interval demands. Forward, and it lightens over the mission, which trims the ship nose-up as the year runs.',
    },
    {
      id: 'water-forward',
